    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', models.CharField(default='fallback.webp', max_length=255)),
                ...
                ('price', djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default=None, default_currency='USD', max_digits=14, null=True)),
                ('mobile_number', models.CharField(max_length=20, unique=True)),
                ('totalChapters', models.IntegerField()),
                ('status', models.CharField(choices=[('free', 'Free'), ('paid', 'Paid')], default='free', max_length=20)),
                ('is_publish', models.BooleanField(default=False)),
                ('category', models.CharField(choices=[('CS', 'Computer Science'), ('IT', 'Information Technology'), ('FS', 'Full Stack'), ('AD', 'App Development'), ('ML', 'Machine Learning'), ('DS', 'Data Science'), ('FE', 'Frontend'), ('BE', 'Backend'), ('OT', 'Other')], default='OT', max_length=20)),
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='authentication.user')),
            ],
            options={
                'db_table': 'course',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coupon_users', models.ManyToManyField(blank=True, related_name='used_coupons', to='authentication.user')),
                ('course', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='coupons', to='teacher.course')),
            ],
            options={
                'db_table': 'couponcode',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='chapters', to='teacher.course')),
            ],
            options={
                'db_table': 'chapter',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='feedbacks', to='teacher.course')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('content', models.TextField()),
                ('feedback', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='replies', to='teacher.feedback')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='replies', to='authentication.user')),
            ],
            options={
                'db_table': 'reply',
            },
